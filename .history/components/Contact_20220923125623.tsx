...
const Contact = ({info}: Props) => {
  ...
  return (
    ...
    <div className='h-screen flex flex-col  overflow-y-scroll scrollbar-hide md:overflow-y-hidden relative items-center justify-center text-center md:text-left'>
