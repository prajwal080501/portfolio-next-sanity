...
const Projects = ({ projects }: Props) => {
    return (
        <motion.div
            ...
            className='h-screen scroll-smooth flex relative items-center overflow-hidden flex-col text-left md:flex-row max-w-full overflow-y-scroll justify-evenly mx-auto z-0'>
