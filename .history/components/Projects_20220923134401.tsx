                ...
                {projects.map(((project, i) => (
                    <div key={project._id} className='w-screen  flex-shrink-0 flex flex-col space-y-5 p-20md:p-44  h-screen bg-black/10 items-center justify-center snap-center text-center'>
                        <motion.img
                            ...
                            viewport={{ once: true }}
                            src={urlFor(project.image).url()} className='h-52 md:h-[30vh] mt-80 md:mt-0 w-[60vh]  mx-auto' alt="" />
                        <div className='space-y-10  px-0 md:px-10 max-w-6xl'>
                            ...
                            <p className='px-5 mx-auto text-lg text-center md:text-left'>
                                ...
                                <div className='flex items-center h-1/2 overflow-y-scroll mb-10 space-x-4 justify-center'>
