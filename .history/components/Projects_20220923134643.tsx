...
const Projects = ({ projects }: Props) => {
    return (
        <motion.div
            ...
            <div className='relative w-full flex overflow-x-scroll overflow-y-scroll snap-x snap-mandatory z-20  scrollbar-hide'>
                {projects.map(((project, i) => (
                    <div key={project._id} className='w-screen  flex-shrink-0 flex flex-col space-y-5 p-20md:p-44  h-screen bg-black/10 items-center justify-center snap-center text-center'>
                        <motion.img
                            ...
                            viewport={{ once: true }}
                            src={urlFor(project.image).url()} className='h-52 md:h-[20vh] mt-52 md:mt-0    w-[40vh]  mx-auto' alt="" />
