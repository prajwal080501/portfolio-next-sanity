        ...
        <motion.div
            ...
            <div className='relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20  scrollbar-hide'>
                {projects.map(((project, i) => (
                    <div key={project._id} className='w-screen  flex-shrink-0 flex flex-col space-y-5 p-20md:p-44  bg-black/10 items-center justify-center snap-center text-center overflow-y-scroll h-[80vh]'>
                        <motion.img
