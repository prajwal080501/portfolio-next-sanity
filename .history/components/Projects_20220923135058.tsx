        ...
        <motion.div
            ...
            <div className='relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20  scrollbar-hide'>
                {projects.map(((project, i) => (
                    <div key={project._id} className='w-screen  flex-shrink-0 flex flex-col space-y-5 p-20md:p-44  bg-black/10 items-center justify-center snap-center text-center overflow-y-scroll h-[90vh]'>
                        <motion.img
                            ...
                            <p className='px-5 mx-auto text-lg text-center md:text-left'>
                                ...
                                <div className='flex items-center mb-10 space-x-4 justify-center'>
                                    ...
                                    {project.technologies.map(tech=> (
                                        <div>
                                            <img src={urlFor(tech.image).url()} className="h-24 w-24" alt="" />
                                        </div>
                                    ))}
                                </div>
                        </div>
