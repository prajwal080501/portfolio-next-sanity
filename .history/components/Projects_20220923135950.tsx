        ...
        <motion.div
            ...
            <div className='relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20  scrollbar-hide'>
                {projects.map(((project, i) => (
                    <div key={project._id} className='w-screen  flex-shrink-0 flex flex-col space-y-5 p-20md:p-44  bg-black/10 items-center justify-center snap-center text-center  md:overflow-y-hidden h-[90vh]'>
                        <motion.img
                            initial={{ y: -300, opacity: 0 }}
                            transition={{ duration: 1.2 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            src={urlFor(project.image).url()} className='h-52 md:h-[20vh] mt-20 md:mt-0    w-[40vh]  mx-auto' alt="" />
                        <div className='space-y-10  px-0 md:px-10 max-w-6xl '>
                            ...
                            <p className='px-5 mx-auto text-lg text-center md:text-left'>
                                ...
                                <div className='flex items-center mb-10 space-x-4 pb-10 justify-center'>
            ...
            <div
                ...
                className='w-full mb-24 absolute top-[30%] blur-sm -z-20 object-contain bg-orange-400/10 left-0 h-[300px] mt-10  -skew-y-12 animate-pulse' />
        </motion.div>
    )
}
