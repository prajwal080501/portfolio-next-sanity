        ...
        <div className='group relative flex cursor-pointer'>
            {skills.map((skill)=> (
                ...
                <motion.img
                            ...
                            viewport={{ once: true }}
                            src={urlFor(skill.image)} alt="" className='h-20 w-20 md:w-24 md:h-24 rounded-full border border-gray-500 object-cover filter group-hover:grayscale duration-300 ease-linear transition ' />
