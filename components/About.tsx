...
const About = (props: Props) => {
    return (
        <div className='flex scroll-smooth flex-col relative h-screen text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center pb-42'>
